-- Student Home subject tiles: roll topic rows up to subject.
-- Apply in Supabase SQL editor if migration not yet deployed.
-- Mirrors supabase/migrations/20260802350000_student_home_subject_rollup.sql
