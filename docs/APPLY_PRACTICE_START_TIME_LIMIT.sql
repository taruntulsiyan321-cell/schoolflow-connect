-- Manual apply helper (Supabase SQL editor) if migrations are not auto-applied.
-- Persist time_limit_sec on rpc_start_practice_session (timed/mock resume honesty).
