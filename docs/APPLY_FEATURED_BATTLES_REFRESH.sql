...
-- Migrations: 20260803220000_featured_battles_refresh.sql
--             + 20260803240000_featured_teacher_topper_warm.sql
-- (Also safe after 20260803200000 / 20260803230000.)
--
-- Daily / NCERT = calendar day; Weekly = ISO week; expire + seed via
-- rpc_refresh_featured_battles. Teacher = live custom/manual/bank.
-- Beat the Topper = on-demand duel (graceful if no classmate XP).
-- =============================================================================
-- =============================================================================
-- APPLY_FEATURED_BATTLES_REFRESH.sql
...
--
-- Provides:
--   * rpc_refresh_featured_battles() â€” close expired daily/ncert/weekly,
--     seed current-window challenges per class (safe to run often)
--   * rpc_rotate_featured_battles() â€” close-only compat helper
--   * rpc_ensure_featured_battles_all() â€” caller warm for Daily/Weekly/NCERT
...
-- Ã¢â€â‚¬Ã¢â€â‚¬ 1. System creator for class-scoped featured inserts Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
-- Ã¢â€â‚¬Ã¢â€â‚¬ 2. Fill questions without auth.uid() (cron / refresh path) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
-- Ã¢â€â‚¬Ã¢â€â‚¬ 3. Seed one featured kind for a class (current window) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
-- Ã¢â€â‚¬Ã¢â€â‚¬ 4. rpc_refresh_featured_battles Ã¢â‚¬â€ close expired + seed current Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
-- Ã¢â€â‚¬Ã¢â€â‚¬ 4b. Compat: close-only rotate (no updated_at Ã¢â‚¬â€ battles has none) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
-- Ã¢â€â‚¬Ã¢â€â‚¬ 5. Optional pg_cron (hourly) Ã¢â‚¬â€ no-op if extension unavailable Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
DO $$
BEGIN
...
-- ── Teacher / Beat Topper / warm ensure polish ──
-- Featured polish (runs after period refresh + seed refresh):
--   * Teacher Challenge â†’ live teacher-hosted custom/manual/bank battles
--   * Beat the Topper â†’ reuse open duel; soft unlock message
...
BEGIN
  ...
  ELSIF _kind = 'beat_topper' THEN
    ...
    ELSE
      ...
      IF _topper_uid IS NULL THEN
        RAISE EXCEPTION 'Beat the Topper unlocks when a classmate has XP â€” check back soon.';
      END IF;

      INSERT INTO public.battles (title, subject, difficulty, type, status, class_id,
        creator_user_id, per_question_sec, question_count, duration_sec, is_public, mode, source, starts_at, class_level)
      VALUES ('Beat the Topper Â· ' || _topper_name, _subj, 'hard', 'mcq', 'live', _cid,
  ...
  ELSIF _kind = 'teacher' THEN
    ...
    IF _existing IS NULL THEN
      RAISE EXCEPTION 'No teacher-hosted challenge is live right now â€” check back soon.';
    END IF;
    _bid := _existing;
