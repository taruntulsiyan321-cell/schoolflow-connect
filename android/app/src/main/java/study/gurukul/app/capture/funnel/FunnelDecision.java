...
/** Outcome of one frame through §5.1–§5.4 (+ send-cooldown). */
public enum FunnelDecision {
  ...
  DROP_RECENT_DUPLICATE,  // same fingerprint within cooldown — §8 cost
  SEND                    // survived all gates — may touch the network
}
