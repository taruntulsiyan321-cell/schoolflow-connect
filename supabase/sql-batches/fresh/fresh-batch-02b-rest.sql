-- Run AFTER fresh-batch-02a-principal-only.sql (must be a NEW query)
-- FRESH DATABASE batch 2 part B
...
-- â”€â”€ 20260507070000_homework_tables.sql
...
-- â”€â”€ 20260507070100_library_tables.sql
