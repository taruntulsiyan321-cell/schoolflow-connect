-- Analysis subject rollup: GROUP BY canonical subject aliases, drop placeholder labels.
-- Extends 20260802350000_student_home_subject_rollup with Maths/Math normalization.
