...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.school_inquiries TO authenticated;
GRANT ALL ON public.school_inquiries TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.school_complaints TO authenticated;
GRANT ALL ON public.school_complaints TO service_role;
