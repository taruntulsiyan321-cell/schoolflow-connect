-- Academic Progression Engine — XP, levels, leagues, badges, achievements,
...
COMMENT ON TABLE public.progression_xp_rules IS
  'Configurable XP award/deduction amounts. Engine reads these — UI never invents XP.';
...
INSERT INTO public.progression_xp_rules (code, label, direction, amount, reputation_delta, category, description) VALUES
  ...
  ('test.high_accuracy', 'High test accuracy', 'award', 40, 4, 'test', '≥90% accuracy on a test'),
...
-- Teacher class progression insights (no gamification admin — insight lists only)
...
-- ---------------------------------------------------------------------------
-- 12) Wire practice finish → progression (unify xp_earned into student_xp)
-- ---------------------------------------------------------------------------
