-- ROLLBACK of 20261103000000_the_recovery_reminder_counts_its_sessions:
-- send_learning_reminders as 20261102000000 wrote it.
...
DELETE FROM public.schema_migrations WHERE version = '20261103000000_the_recovery_reminder_counts_its_sessions';
