-- ROLLBACK 20261093000000 — the plan plans withdrawn bank originals again and
-- submit scores them (both definitions as live before it, verbatim).
BEGIN;
...
DELETE FROM public.schema_migrations WHERE version = '20261093000000_a_withdrawn_question_is_not_planned_or_scored';
