-- ROLLBACK of 20261097000000_a_variant_answer_is_recorded_as_its_original:
-- rpc_record_question_attempt as it stood before.
...
DELETE FROM public.schema_migrations WHERE version = '20261097000000_a_variant_answer_is_recorded_as_its_original';
