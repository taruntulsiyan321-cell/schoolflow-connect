-- ROLLBACK 20261094000000 — a waiting recovery plan is rebuilt only when the
-- open-mistake count changes (the definition live before it, verbatim).
BEGIN;
...
DELETE FROM public.schema_migrations WHERE version = '20261094000000_a_waiting_recovery_is_rebuilt_when_its_questions_change';
