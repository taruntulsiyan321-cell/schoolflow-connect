    ...
    <div className="bg-card border border-[#3b5bdb]/20 rounded-2xl p-5 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="col-span-2">
          <button type="button" disabled className="flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-semibold text-muted-foreground bg-black/5 cursor-not-allowed">
      ...
      <div className="flex gap-3 justify-end pt-2">
        <button type="button" onClick={onCancel} className="px-4 py-2 rounded-xl text-xs font-semibold text-muted-foreground bg-black/5 hover:bg-black/10">Cancel</button>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex gap-1.5 shrink-0">
                      <button type="button" onClick={() => setEditingId(a.id)}
                        className="w-7 h-7 rounded-lg bg-black/5 text-muted-foreground flex items-center justify-center hover:bg-black/10 hover:text-foreground transition-all">
