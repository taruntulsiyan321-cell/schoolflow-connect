    ...
    <div className="space-y-4">
      ...
      <Card className="p-4 flex items-start gap-3 border-[#3b5bdb]/30 bg-[#3b5bdb]/5">
        ...
        <div className="text-xs text-[#a5b0d8] leading-relaxed">
          <span className="font-bold text-white">Coming soon.</span> This will generate the same
      ...
      {loading ? (
        <div className="text-xs text-[#78788c] py-8 text-center">Loading your classes…</div>
      ) : classes.length === 0 ? (
        <div className="text-xs text-[#78788c] py-8 text-center">No assigned classes found.</div>
      ) : (
        <Card className="p-4 flex flex-wrap items-center gap-3">
          <div className="flex flex-col gap-1">
            <label htmlFor="ai-coach-class" className="text-[9px] font-bold text-[#78788c] uppercase tracking-wider">
              Class
            </label>
            <select
              id="ai-coach-class"
              ...
              className="bg-[#0a0a0c] border border-white/10 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-[#3b5bdb]/50"
            >
              {classes.map((c) => (
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="ai-coach-student" className="text-[9px] font-bold text-[#78788c] uppercase tracking-wider">
              Student
            </label>
            <select
              id="ai-coach-student"
              ...
              className="bg-[#0a0a0c] border border-white/10 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-[#3b5bdb]/50 disabled:opacity-50"
            >
              {students.map((s) => (
          ...
          <button
            ...
            className="ml-auto flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold text-[#78788c] bg-white/5 border border-white/10 cursor-not-allowed"
          >
      ...
      <Card className="p-5 sm:p-6 opacity-60">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div className="text-[10px] font-bold text-[#78788c] uppercase tracking-wider">
