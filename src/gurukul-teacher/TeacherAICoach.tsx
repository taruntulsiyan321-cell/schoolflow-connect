...
/**
 * UI/UX preview only â€” deliberately not wired to a real backend call.
 ...
 * plans), aggregated per-class for a teacher's diagnostic view â€” that
    ...
    <div className="space-y-4">
      ...
      <Card className="p-4 flex items-start gap-3 border-[#3b5bdb]/30 bg-[#3b5bdb]/5">
        ...
        <div className="text-xs text-[#a5b0d8] leading-relaxed">
          ...
          kind of AI coaching report students already see for themselves â€” diagnosis, focus
          areas, recommendations â€” but built from your class&apos;s student-panel data so you can
      ...
      {loading ? (
        <div className="text-xs text-muted-foreground py-8 text-center">Loading your classesâ€¦</div>
      ) : classes.length === 0 ? (
      ...
      {/* Preview of the eventual report shape â€” explicitly labeled as an example */}
      <Card className="p-5 sm:p-6 opacity-60">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">
            Example preview{selectedStudent ? ` â€” ${selectedStudent.fullName}` : ""}
          </div>
        </div>
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-2 text-xs text-[#c8c8d4]">
            ...
            questions â€” likely a formula-recall gap, not a conceptual one.
          </div>
