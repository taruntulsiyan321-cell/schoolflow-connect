      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {features.map((f) => (
          <button
            ...
            className="group text-left p-5 rounded-2xl border border-black/7 bg-card/90 transition-all duration-200 hover:border-black/20 hover:scale-[1.02]"
          >
        ...
        <GlassCard className="p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <button
              ...
              className="ml-auto text-[10px] text-[#3b5bdb] hover:text-muted-foreground transition-colors"
            >
              View →
            </button>
          </div>
