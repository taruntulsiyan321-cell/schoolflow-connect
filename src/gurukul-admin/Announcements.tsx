  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-lg font-bold text-[#1a1a2e]">Announcements</h1>
      ...
      <div className="flex gap-1 p-1 bg-white border border-[#e5e7eb] rounded-2xl w-fit flex-wrap">
        {(["all", "published", "draft", "scheduled"] as const).map((t) => (
          <button
            ...
            className={cn(
              ...
              tab === t ? "bg-[#3b5bdb]/15 text-[#3b5bdb]" : "text-[#78788c] hover:text-[#1a1a2e]",
            )}
          >
            {t}
      ...
      <div className="rounded-2xl border border-[#e5e7eb] bg-white overflow-hidden">
        {filtered.length === 0 ? (
          <div className="flex flex-col items-center gap-3 py-16">
            <Bell className="w-8 h-8 text-[#c4c4d0]" />
                ...
                <div key={ann.id} className="p-4 flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap mb-1">
                      <span className="text-sm font-bold text-[#1a1a2e]">{ann.title}</span>
                      <span
                      ...
                      <span className="text-[9px] px-2 py-0.5 rounded-full bg-[#f0f1f3] text-[#78788c]">
                        {ann.audience}
                      </span>
                    </div>
                    ...
                    <div className="text-xs text-[#46465a] mt-2 line-clamp-2">{ann.body}</div>
                  </div>
