...
export function AccountLinkingPanel({ entityName, entityType, status }: AccountLinkingProps) {
  return (
    <div className="space-y-3">
      ...
      <div className="p-3 rounded-xl bg-black/3 space-y-2 opacity-60">
      ...
      <div className="space-y-2 opacity-50 pointer-events-none">
        <div className="w-full flex items-center gap-2 px-3 py-2.5 rounded-xl text-xs font-semibold bg-black/5 text-muted-foreground">
