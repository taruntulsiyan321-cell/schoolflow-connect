...
function Sidebar({
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        "flex items-center gap-3 px-4 py-5 border-b border-black/7",
                    ...
                    <>
                      ...
                      {item.badge && (
                        <span className={cn(
                          ...
                          active ? "bg-[#3b5bdb]/30 text-muted-foreground" : "bg-black/8 text-muted-foreground"
                        )}>
                          {item.badge}
                        </span>
                      )}
      ...
      {onSignOut && (
        <div className="p-2 border-t border-black/7">
          <button
            onClick={onSignOut}
            className={cn(
