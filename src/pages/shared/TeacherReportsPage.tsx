      ...
      <section className="tp-hero">
        <div className="relative z-10 flex flex-wrap items-end justify-between gap-5">
          <div>
            ...
            <p className="text-sm text-foreground/75 mt-2 max-w-2xl">Class, student, recovery, practice, improvement, and readiness signals in one premium teacher report.</p>
          </div>
