      ...
      <header className="landing-nav sticky top-0 z-30">
        <div className="container mx-auto flex items-center justify-between px-4 h-[72px]">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-lg tracking-tight">Gurukul</span>
        ...
        <div className="landing-hero-grid container mx-auto px-4 py-20 md:py-28 grid md:grid-cols-[1.05fr_.95fr] gap-12 items-center">
          <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl text-foreground/70 mt-5 max-w-xl leading-relaxed">
              Gurukul brings school operations and student growth into one clear,
...
function FeatureCard({ icon: Icon, title, desc, live }: { icon: LucideIcon; title: string; desc: string; live?: boolean }) {
  return (
...
function StackCard({ icon: Icon, title, desc }: { icon: LucideIcon; title: string; desc: string }) {
  return (
