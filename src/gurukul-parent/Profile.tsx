...
export default function ParentProfile() {
  ...
  // Escape-+ a simple focus trap while the Change Password dialog is open.
  useEffect(() => {
      ...
      {changePwdOpen && (
        <div className="fixed inset-0 z-modal flex items-center justify-center p-4">
          ...
          <div
            ...
            className="relative z-10 bg-card border border-black/10 rounded-2xl w-full max-w-sm p-5 shadow-2xl space-y-4"
          >
            ...
            <div className="flex gap-3 justify-end">
              <button
                ...
                className="px-4 py-2 rounded-xl text-xs font-semibold text-muted-foreground bg-black/5 hover:bg-black/10 transition-all"
              >
                Cancel
              </button>
              <button
