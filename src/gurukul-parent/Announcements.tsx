  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2">
        <div className="flex items-center gap-2 bg-black/5 border border-black/10 rounded-xl px-3 py-2 flex-1 min-w-40">
      ...
      <div className={cn("grid gap-4", selected ? "grid-cols-1 lg:grid-cols-5" : "grid-cols-1")}>
              ...
              <button
                ...
                className={cn(
                  ...
                  selected === a.id
                    ...
                    : "bg-card border-black/7 hover:border-black/15",
                )}
              >
        ...
        {detail && (
          <div className="lg:col-span-3 bg-card border border-black/7 rounded-2xl p-5 space-y-4">
            ...
            {detail.hasAttachment && (
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#6366f1]/10 border border-[#6366f1]/20 text-xs font-semibold text-muted-foreground">
