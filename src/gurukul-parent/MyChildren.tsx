...
function InfoRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-col gap-0.5 p-3 rounded-xl bg-black/3">
  ...
  return (
    <div className="space-y-4">
            ...
            <button key={c.id} onClick={() => { setActiveChildId(c.id); setTab("profile"); }}
              className={cn("flex items-center gap-3 px-4 py-3 rounded-2xl border transition-all text-left",
                c.id === liveChild?.id
                  ...
                  : "bg-card border-black/7 text-muted-foreground hover:border-black/15")}>
      ...
      <div className="bg-card border border-black/7 rounded-2xl overflow-hidden">
        <div className="p-5 border-b border-black/7 flex items-center gap-4 bg-[#3b5bdb]/5">
        ...
        <div className="flex gap-1 px-4 py-3 border-b border-black/7 overflow-x-auto">
