  ...
  public: {
    Tables: {
      ...
      attendance_submissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "attendance_submissions_academic_year_id_fkey"
            columns: ["academic_year_id"]
            isOneToOne: false
            referencedRelation: "academic_years"
            referencedColumns: ["id"]
      ...
      chapters: {
        ...
        Relationships: [
          {
            foreignKeyName: "chapters_curriculum_subject_id_fkey"
      ...
      class_groups: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "class_groups_curriculum_class_id_fkey"
            columns: ["curriculum_class_id"]
            isOneToOne: false
      ...
      cuet_bank_repair_20261084: {
        Row: {
          action: string
          kept_id: string | null
          old_embed_status: string | null
      ...
      curriculum_classes: {
        ...
        Relationships: [
          {
            foreignKeyName: "curriculum_classes_board_id_fkey"
            columns: ["board_id"]
            isOneToOne: false
      ...
      curriculum_subjects: {
        ...
        Relationships: [
          {
            foreignKeyName: "curriculum_subjects_curriculum_class_id_fkey"
            columns: ["curriculum_class_id"]
            isOneToOne: false
            referencedRelation: "curriculum_classes"
            referencedColumns: ["id"]
      ...
      exam_syllabus_chapters: {
        ...
        Relationships: [
          {
            foreignKeyName: "exam_syllabus_chapters_chapter_id_fkey"
            columns: ["chapter_id"]
            isOneToOne: false
            referencedRelation: "chapters"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "exam_syllabus_chapters_exam_id_fkey"
            columns: ["exam_id"]
            isOneToOne: false
            referencedRelation: "competitive_exams"
            referencedColumns: ["id"]
      ...
      homework_submissions_pre_20260925110000: {
        Row: {
          attachments: Json | null
          content: string | null
          created_at: string | null
      ...
      notification_links_pre_20260925180000: {
        Row: {
          id: string
          link: string
        }
      ...
      question_attempts: {
        Row: {
          ...
          created_at: string
          difficulty: string | null
          excluded_from_accuracy: boolean
      ...
      recovery_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "recovery_sessions_practice_session_id_fkey"
      ...
      revision_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "revision_sessions_practice_session_id_fkey"
            columns: ["practice_session_id"]
            isOneToOne: false
            referencedRelation: "practice_sessions"
            referencedColumns: ["id"]
      ...
      rls_pre_20260925160000: {
        Row: {
          acl: string | null
          applied: string | null
          applied_acl: string | null
      ...
      section_subjects: {
        ...
        Relationships: [
          {
            foreignKeyName: "section_subjects_curriculum_subject_id_fkey"
            columns: ["curriculum_subject_id"]
            isOneToOne: false
            referencedRelation: "curriculum_subjects"
            referencedColumns: ["id"]
      ...
      sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sessions_membership_belongs_to_account"
            columns: ["active_membership_id", "account_id"]
            isOneToOne: false
            referencedRelation: "memberships"
      ...
      student_capture_questions: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_capture_questions_chapter_id_fkey"
            columns: ["chapter_id"]
            isOneToOne: false
            referencedRelation: "chapters"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_capture_questions_matched_bank_question_id_fkey"
            columns: ["matched_bank_question_id"]
            isOneToOne: false
            referencedRelation: "question_bank"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "student_capture_questions_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_capture_questions_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "topics"
            referencedColumns: ["id"]
      ...
      student_enrolments: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_enrolments_academic_year_id_fkey"
            columns: ["academic_year_id"]
            isOneToOne: false
            referencedRelation: "academic_years"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_enrolments_section_id_fkey"
            columns: ["section_id"]
            isOneToOne: false
            referencedRelation: "classes"
            referencedColumns: ["id"]
      ...
      student_mistakes: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_mistakes_capture_question_id_fkey"
          ...
          {
            foreignKeyName: "student_mistakes_upload_question_id_fkey"
      ...
      student_upload_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_upload_notes_chapter_id_fkey"
            columns: ["chapter_id"]
            isOneToOne: false
            referencedRelation: "chapters"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_upload_notes_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_upload_notes_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "topics"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_upload_notes_upload_id_fkey"
            columns: ["upload_id"]
            isOneToOne: false
      ...
      student_upload_questions: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_upload_questions_chapter_id_fkey"
            columns: ["chapter_id"]
            isOneToOne: false
            referencedRelation: "chapters"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_upload_questions_derived_from_note_id_fkey"
            columns: ["derived_from_note_id"]
            isOneToOne: false
            referencedRelation: "student_upload_notes"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "student_upload_questions_matched_bank_question_id_fkey"
            columns: ["matched_bank_question_id"]
            isOneToOne: false
            referencedRelation: "question_bank"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_upload_questions_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_upload_questions_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "topics"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "student_upload_questions_upload_id_fkey"
            columns: ["upload_id"]
            isOneToOne: false
            referencedRelation: "student_uploads"
            referencedColumns: ["id"]
      ...
      student_uploads: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_uploads_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
      ...
      super_admin_access_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "super_admin_access_log_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "schools"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "super_admin_access_log_super_admin_id_fkey"
      ...
      super_admins: {
        ...
        Relationships: [
          {
            foreignKeyName: "super_admins_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: true
            referencedRelation: "accounts"
            referencedColumns: ["id"]
      ...
      teacher_assignments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "teacher_assignments_section_subject_fk"
            columns: ["section_subject_id", "school_id"]
            isOneToOne: false
            referencedRelation: "section_subjects"
            referencedColumns: ["id", "school_id"]
    ...
    Functions: {
      ...
      progression_league_for_xp: {
        Args: { _current_league?: string; _xp: number }
        Returns: string
      }
      ...
      rpc_battle_curriculum: {
        Args: { _class_id?: string; _subject: string }
        Returns: Json
      }
      rpc_battle_feed: {
        Args: { _limit?: number }
      ...
      rpc_dispute_ai_upload_answer: {
        Args: { _upload_question_id: string }
        Returns: Json
      }
      rpc_enqueue_upload_variant_generation: {
        Args: { _tier?: number; _upload_question_id: string }
        Returns: string
      }
      ...
      rpc_invite_member: {
        Args: {
          _identifier_type: Database["public"]["Enums"]["identifier_type"]
          _identifier_value: string
          _local_person_id?: string
          _role: Database["public"]["Enums"]["app_role"]
        }
        Returns: string
      }
      ...
      rpc_submit_recovery_session: {
        Args: { _practice_session_id: string; _session_id: string }
        Returns: Json
      }
      rpc_submit_revision_session: {
        Args: { _chapter_id: string; _practice_session_id: string }
        Returns: Json
      }
      rpc_super_admin_open_access: {
        Args: {
          _minutes?: number
          _reason: string
          _school_id: string
          _what_was_accessed: string
        }
        Returns: string
      }
      rpc_switch_membership: {
      ...
      store_generated_questions: { Args: { _questions: Json }; Returns: Json }
